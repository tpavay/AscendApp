...
/// has a Reduce Motion answer. With it on, nothing animates: a block takes its new size,
/// position and order in a single frame, and the reorder lift and the selection change land
/// the same way. Nothing here returns an animation that would still move geometry.
