...
Also not gated: anything a Cloud Function or an operator-run script writes, such as the server-side leaderboard derivation or Home's `home_today_activity` projection.
