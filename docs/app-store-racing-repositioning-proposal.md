...
6. **The attached build is 2026081101, or the notes were re-checked against a newer one.** `docs/heart-rate-zones-plan.md` owns the decision to submit 1.0 without the watch app and ship it in 1.2.
