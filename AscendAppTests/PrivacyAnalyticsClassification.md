...
| Product Interaction | `screen_id`, `step_id`, `from_step`, `flow_id`, `flow_version`, `segment_id`, `step_index`, `step_count`, `resume`, `completion_reason`, `app_environment`, `action_id`, `input_type`, `selection_type`, `answer_index`, `has_answer`, `viewed`, `completed`, `question_id`, `provider`, `source`, `entry_point`, `surface`, `share_surface`, `card_type`, `home_state`, `action_state`, `can_start`, `blocked_reason`, `selection_method`, `display_name_provided`, `total_climbs_bucket`, `filter_group`, `filter_type`, `metric`, `time_frame`, `active_filter_count`, `has_active_filters` | Navigation, funnel position, and interaction shape across every feature |
